  ...
  const settings = [
	...
	return (
      ...
      <Notifications />
          ...
          {
            // this what you mean? I need to know where the (themes, blah blah is) oh
          }
				</div>
			</main>
		</div>
